...
namespace Mvc.Server {
    public class AuthorizationController : Controller {
        ...
        [Authorize, HttpGet, Route("api/connect/authorize")]
        ...
        [Authorize, HttpPost("api/connect/authorize/accept"), ValidateAntiForgeryToken]
        ...
        [Authorize, HttpPost("api/connect/authorize/deny"), ValidateAntiForgeryToken]
        ...
        private async Task<AuthenticationTicket> CreateTicketAsync(OpenIdConnectRequest request, ApplicationUser user) {
            ...
            var ticket = new AuthenticationTicket(
                ...
                // 加入 ExpiresUtc 但也可以在 Startup 中設定
                // new AuthenticationProperties {
